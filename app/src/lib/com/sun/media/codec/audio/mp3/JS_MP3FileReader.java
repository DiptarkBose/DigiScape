...
//        throw exception;
        ...
        throws UnsupportedAudioFileException, IOException
   {
        ...
        fileFormat = getAudioFileFormat(((InputStream) (fis)), false, 16384);
        fis.close();
...
//        throw exception;
        ...
        throws UnsupportedAudioFileException, IOException
    {
        ...
        result = getAudioInputStream(((InputStream) (bis)), 16384);
        if(result == null)
            urlStream.close();
        ...
        if(!triedTritonus || tGetType != null)
            try
            {
                ...
                if(!triedTritonus)
                {
                    ...
                    tGetType = tAudioFileTypes.getMethod("getType", new Class[] {
