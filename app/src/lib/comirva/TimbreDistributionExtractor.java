...
public class TimbreDistributionExtractor implements AudioFeatureExtractor {
	 ...
	 * distribution.
	 * 
	 * @param numberGaussianComponents
	 *            int number of gaussian components
	 * @param skipIntro
	 *            int number of seconds to skip at the beginning of the song
	 * @param skipEnd
	 *            int number of seconds to skip at the end of the song
	 * @param minimumLength
	 *            int minimum length required for processing
	 */
	 ...
	 * 
	 * @throws IOException
	 *             failures due to io operations are signaled by IOExceptions
	 * @throws IllegalArgumentException
	 *             raised if mehtod contract is violated, especially if the open
